            ...
            (function ($) {
                if (${sessionScope.eu == null}) {
                    ...
                    if (stock > 0) {
                        ...
                        var loginName = "${sessionScope.eu.loginName}";
                        var num = $(".n_ipt").val();
                        $.post("/ProductCategoryServlet?opr=addProduct", "id=" + id + "&loginName=" + loginName + "&num=" + num, callback, "json");
...
<div class="menu_bg">
    <div class="menu">
        ...
        <ul class="menu_r">
            ...
            <c:forEach items="${sessionScope.list}" var="temp1">
                <li><a href="Food.html">${temp1.name}</a></li>
            </c:forEach>
...
<div class="i_bg">
    <div class="postion">
    	<span class="fl">
            全部 >
            <c:forEach items="${requestScope.product.list}" var="temp">
                ${temp.name} >
            </c:forEach>
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS">
                <a href="files/${requestScope.product.fileName}" title="Images" class="MagicZoom" id="MagicZoom">
                    <img src="files/${requestScope.product.fileName}" width="390" height="390"/>
                </a>
            </div>
                ...
                <div id="tsImgSCon">
                    <ul>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img
                                src="files/${requestScope.product.fileName}"
                                tsImgS="files/${requestScope.product.fileName}" width="79" height="79"/></li>
                        <li onclick="showPic(1)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(2)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(3)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(4)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(5)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(6)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(7)" rel="MagicZoom"><img src="files/${requestScope.product.fileName}"
                                                                      tsImgS="files/${requestScope.product.fileName}"
                                                                      width="79" height="79"/></li>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            <div class="des_name">
                <p>
                    ${requestScope.product.name}
                    <%--Dior/迪奥 真我香水EDP 克丽丝汀迪奥 全新 30ml--%>
                </p>
            ...
            <div class="des_join">
                ...
                <span class="fl">
                    <a href="javascript:;" onclick="addproc(${requestScope.product.stock})">
    ...
    <div class="content mar_20">
        <div class="l_history">
            ...
            <ul>
                <li>
                    <div class="img"><a href="#"><img src="files/${requestScope.product.fileName}" width="185"
                                                      height="162"/></a></div>
                    <div class="name"><a href="#">${requestScope.product.name}</a></div>
                    <div class="price">
                        <font>￥<span>${requestScope.product.price}</span></font> &nbsp; 18R
                    </div>
                </li>
                <li>
                    <div class="img"><a href="#"><img src="files/${requestScope.product.fileName}" width="185"
        ...
        <div class="l_list">
            <div class="des_border">
                ...
                <div class="team_list">
                    <div class="img"><a href="#"><img src="files/${requestScope.product.fileName}" width="160"
                                                      height="140"/></a></div>
                    <div class="name"><a href="#">${requestScope.product.name}</a></div>
                    <div class="price">
                        <div class="checkbox"><input id="b1" type="checkbox" name="zuhe" checked="checked"/></div>
                        <font>￥<span>${requestScope.product.price}</span></font> &nbsp; 18R
                    </div>
                </div>
                ...
                <div class="team_list">
                    ...
                    <div class="name"><a href="#">${requestScope.product.name}</a></div>
                    <div class="price">
                        <div class="checkbox"><input id="b2" type="checkbox" name="zuhe"/></div>
                        <font>￥<span>${requestScope.product.price}</span></font> &nbsp; 18R
                    </div>
                </div>
                <div class="team_icon"><img src="images/jia_b.gif"/></div>
                <div class="team_list">
                    ...
                    <div class="name"><a href="#">${requestScope.product.name}</a></div>
                    <div class="price">
                        <div class="checkbox"><input id="b3" type="checkbox" name="zuhe" checked="checked"/></div>
                        <font>￥<span>${requestScope.product.price}</span></font> &nbsp; 18R
                    </div>
                </div>
                <div class="team_icon"><img src="images/equl.gif"/></div>
                <div class="team_sum">
                    套餐价：￥<span id="price">${requestScope.product.price*2}</span><br/>
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                    <table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';"
                           cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="265"><img src="files/${requestScope.product.fileName}" width="206" height="412"/>
                            </td>
                            <td>
                    ...
                    <p align="center">
                        <img src="files/${requestScope.product.fileName}" width="746" height="425"/><br/><br/>
                        <img src="files/${requestScope.product.fileName}" width="750" height="417"/><br/><br/>
                        <img src="files/${requestScope.product.fileName}" width="750" height="409"/><br/><br/>
                        <img src="files/${requestScope.product.fileName}" width="750" height="409"/>
                    </p>
