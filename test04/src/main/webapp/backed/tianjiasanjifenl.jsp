            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form1" action="/ProductBackServlet?opr=addProductCategory&parentId=${requestScope.pro.id}&type=3"  method="post">
                        	...
                        	<div class="form-group">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label"><span style="color:red;" >*</span>三级名称：</label>
									<div class="col-sm-8" >
										<input type="text" name="name"  placeholder=" 请输入名称 " value="" id="username"  maxlength="40" class="form-control">
									</div>
								</div>
