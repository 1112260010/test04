            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" id="form1" action="/ProductBackServlet?opr=addProductCategory&type=1&parentId=0"  method="post">
                        	...
                        	<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8" >
										<input type="text" name="name"  placeholder=" 请输入名称 " value="" id="name"  maxlength="40" class="form-control">
									</div>
								</div>
